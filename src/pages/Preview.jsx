              ...
              <div className="gap-4 flex flex-row">
                <button className="bg-white w-97 h-58 rounded-lg border border-[#DBDBDC] shadow-md flex items-center justify-center relative">
                  <img
                    src={iconArrowLeft}
                    alt="icon arrow left"
                    className="h-6 w-3 absolute left-4 top-1/2 transform -translate-y-1/2 cursor-pointer"
                  />
                ...
                <button className="bg-white w-97 h-58 rounded-lg border border-[#DBDBDC] shadow-md flex items-center justify-center relative">
                  <img
                    ...
                    className="h-6 w-3 absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer"
                  />
                  <button className="h-full w-full flex items-center justify-center cursor-pointer">
          ...
          <div className="flex justify-between py-8">
            ...
            <div className="w-1/2">
              ...
              <div className="flex gap-8">
                <img src={iconShirtFrontArea} alt="Icon shirt fontside show mark print area" className="h-[72px] w-auto" />
                <img src={iconShirtBackArea} alt="Icon shirt backside show mark print area" className="h-[72px] w-auto" />
              </div>
              <p className="text-xl mt-6 w-190 wrap-text">
                Prove Them Wrong" is about answering doubt with action. It’s not about words it’s about results. This design symbolizes
                those who refuse to be limited by others' expectations and choose to win by proving themselves through real achievements.
              </p>
              <button className="p-2 rounded-md border-1 border-gray-200 mt-2">Read More</button>
