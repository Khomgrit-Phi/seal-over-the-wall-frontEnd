        ...
        <div className="flex justify-between py-8">
          <div>
            ...
            <div className="flex gap-4 mt-4">
              {product?.colors?.map(
                (
                  color // Dynamically render colors
                ) => (
                  <div
                    key={color}
          ...
          <div className="w-1/2">
            ...
            <div className="flex gap-8">
              <img src={logoFrontShirt} alt="" className="h-[72px] w-auto" />
              <img src={backIcon} alt="Back" className="h-[72px] w-auto" />
            </div>
            <p className="text-xl mt-6">
              30% of the money made from this campaign will be donated to Shelter, a TH based housing charity. Designed by @Artists Lalala
              on instagram.
            </p>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <button className="p-2 rounded-md bg-gray-300 text-xl">collection</button>
              <button className="p-2 rounded-md bg-gray-300 text-xl">Artists Lalala</button>
            </div>
          ...
          <div className="w-3/5 pl-20 pr-10">
            <div className="flex gap-8 border-b-1 pb-4">
              <div>
                ...
                <h6 className="inline text-2xl font-semibold">Most shipping options</h6>
                <p className="text-xl">
              ...
              <div>
                ...
                <p>
                  Order optimized based on customer location
                  <br />
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2 items-center">
                <img src={thaiFlag} alt="" className="w-6 h-auto mt-2" />
                <p>Thailand</p>
              </div>
            </div>
          </div>
